    ...
    <div className="max-w-full mx-auto mb-24">
      ...
      <div className="justify-self-end space-x-4 text-sm font-semibold">
        ...
        <div className="justify-self-end">
          <button onClick={toggleButtonHandler} className="bg-white border border-current w-12 h-5 p-3 rounded-full relative bottom-1 right-1">
            <span className={(toggleButton ? "right-0 bg-red-500":"left-0 bg-black") + " w-5 h-5 p-3 absolute top-0 bottom-0 rounded-full"}></span>
          </button>
