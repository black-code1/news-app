  ...
  return (
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="justify-self-end space-x-4 text-sm font-semibold">
        <a href="#">Home<svg className="inline-block h-3 ml-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M0 7.33l2.829-2.83 9.175 9.339 9.167-9.339 2.829 2.83-11.996 12.17z"/></svg></a>
        <a href="#">Blog<svg className="inline-block h-3 ml-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M0 7.33l2.829-2.83 9.175 9.339 9.167-9.339 2.829 2.83-11.996 12.17z"/></svg>
        </a>
        <a href="#">Posts Features<svg className="inline-block h-3 ml-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M0 7.33l2.829-2.83 9.175 9.339 9.167-9.339 2.829 2.83-11.996 12.17z"/></svg></a>
        <a href="#">Pages<svg className="inline-block h-3 ml-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M0 7.33l2.829-2.83 9.175 9.339 9.167-9.339 2.829 2.83-11.996 12.17z"/></svg></a>
        <a href="#">Contact</a>
      </div>
